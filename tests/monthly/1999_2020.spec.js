...
const dl = async (page, ageGroups) => {
  ...
  await page.locator('#SB_2').selectOption('D77.V1-level2') // group by: month
  ...
  await download.saveAs(`./out/monthly/us_states_1999-2020_${ag}.txt`)
}
...
test('Download CDC Wonder Data 1999-2020 [5y groups].', async ({ page }) => {
